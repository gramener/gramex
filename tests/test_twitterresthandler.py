...
class TestTwitterRESTHandler(TestGramex):
    ...
    def test_post(self):
        base = '/api/twitter/'
        self.fetch(base, 'search/tweets.json', BAD_REQUEST)
        ...
        self.fetch(base, 'users/show.json', data={'screen_name': 'gramener', 'count': 2})
        self.fetch(base, 'statuses/user_timeline.json', params={'screen_name': 'gramener'})
