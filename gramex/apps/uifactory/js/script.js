...
$(window).on("click", function (e) {
  if (
    !$(e.target).closest(".edit-properties").length &&
    !$(e.target).closest(".user-form").length
  ) {
...
$("body").on("click", ".user-form > :not(.actions)", function () {
  ...
  $(".edit-properties").empty().data("editing-element", $(this));
  $(".user-form > *").removeClass("highlight");
  $(".edit-properties-title").removeClass("d-none");
  ...
  let names = _.map(values, function (item) {
    return item.name;
  });
